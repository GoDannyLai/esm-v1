...
func (s *ESAPIV5) NewScroll(indexNames string, scrollTime string, docBufferCount int, query string, match string, slicedId, maxSlicedCount int, fields string) (scroll interface{}, err error) {
